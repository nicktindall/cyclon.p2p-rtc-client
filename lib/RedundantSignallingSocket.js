 ...
 * @constructor
 */
function RedundantSignallingSocket (signallingServerService, socketFactory, loggingService, asyncExecService, storage, timingService) {
     ...
     */
    this.connect = function (localSignallingService) {
     ...
     * we're connected to
     *
     * TODO: move this out to announce functionality
     */
    ...
    function filterAndSortAvailableServers (serverArray) {
        ...
        return copyOfServerArray.filter(function (item) {
            ...
            return lastDisconnectTime === undefined || timingService.getCurrentTimeInMilliseconds() - lastDisconnectTime > DELAY_BEFORE_RETRY_MS;
        });
    }
