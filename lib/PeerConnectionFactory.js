...
function PeerConnectionFactory(timingService, rtcObjectFactory, asyncExecService, loggingService) {
    ...
    var peerConnectionConfig = {'iceServers': [
        ...
        rtcObjectFactory.createIceServer('turn:54.187.115.223:3478?transport=tcp', 'cyclonjsuser', 'sP4zBGasNVKI')    // Turn over TCP on 443 for networks with totalitarian security regimes
